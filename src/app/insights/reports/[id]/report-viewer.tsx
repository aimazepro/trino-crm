...
const STACKED_SERIES_COLORS = ["#3b82f6", "#22c55e", "#f59e0b", "#ec4899", "#8b5cf6", "#06b6d4"];
...
function ReportChart({ chartType, data, color }: { chartType: SavedReport["chartType"]; data: { name: string; value: number; [k: string]: string | number | undefined }[]; color: string }) {
