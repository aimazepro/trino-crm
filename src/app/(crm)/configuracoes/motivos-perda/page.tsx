...
function MotivosPerdaPageContent() {
  ...
  return (
    <div className="p-8 max-w-xl">
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-zinc-900">Motivos de Perda</h1>
        <p className="text-sm text-zinc-400 mt-0.5">
          Padronize os motivos para o time inteiro. Aparecem como opções ao marcar um negócio como perdido.
        </p>
      </div>
