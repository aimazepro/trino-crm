...
import {
  ...
  Plus, Search, X, Globe, Users, ChevronRight,
} from "lucide-react";
...
function TimelineItem({ icon: Icon, title, sub, time, color }: {
  icon: React.ElementType; title: string; sub: string; time: string; color: string;
}) {
  return (
      ...
      <div className="flex gap-6 flex-1 min-h-0">
        ...
        <div className="w-72 shrink-0 flex flex-col gap-0 bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="p-5 border-b border-gray-50">
            ...
            <button className="flex items-center gap-1.5 text-sm text-gray-400 hover:text-amber-600 transition-colors font-medium">
              <Plus size={14} /> Vincular empresa mãe
            </button>
          </div>
