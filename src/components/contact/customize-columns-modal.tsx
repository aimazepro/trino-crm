...
export interface ColumnItem {
  id: string;
  label: string;
  category: "Contato" | "Empresa";
  tag: string;
}

export const ALL_COLUMNS: ColumnItem[] = [
  // CONTATO fields
  { id: "name", label: "Nome", category: "Contato", tag: "Contato" },
  { id: "email", label: "Email", category: "Contato", tag: "Contato" },
  { id: "phone", label: "Telefone", category: "Contato", tag: "Contato" },
  { id: "company", label: "Empresa", category: "Contato", tag: "Contato" },
  { id: "owner", label: "Proprietário", category: "Contato", tag: "Contato" },
  { id: "deals", label: "Negócios", category: "Contato", tag: "Contato" },
  { id: "role", label: "Cargo", category: "Contato", tag: "Contato" },
  { id: "createdAt", label: "Criado em", category: "Contato", tag: "Contato" },
...
export const DEFAULT_COLUMNS = ["name", "email", "phone", "company", "owner", "deals"];

const CATEGORIES: ColumnItem["category"][] = ["Contato", "Empresa"];
...
export function CustomizeColumnsModal({ initialColumns, onClose, onSave }: CustomizeColumnsModalProps) {
  ...
  const handleUncheck = (columnId: string) => {
    if (columnId === "name") return; // cannot hide Nome
                          ...
                          {(providedDrag, snapshot) => (
                            ...
                            >
                              ...
                              <div className="flex shrink-0 items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button
                                  type="button"
                                  disabled={index <= 1} // Nome is 0, so cannot move to 0
